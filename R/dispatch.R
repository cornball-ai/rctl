...
operations <- function() {
    ...
    list(
        ...
        rsystemd::systemd_journal(unit = opts[["unit"]],
         ...
         "host.memory" = ro("hwstate",
                            function(pos, opts) hwstate::mem_info()),
         "host.load" = ro("hwstate",
                          function(pos, opts) hwstate::load_average()),
         "host.cpu" = ro("hwstate",
                         function(pos, opts) hwstate::cpu_info()),
         ...
         "host.disks" = ro("hwstate",
                           function(pos, opts) hwstate::disks()),
         ...
         "host.gpus" = ro("hwstate",
                          function(pos, opts) hwstate::gpus()),
